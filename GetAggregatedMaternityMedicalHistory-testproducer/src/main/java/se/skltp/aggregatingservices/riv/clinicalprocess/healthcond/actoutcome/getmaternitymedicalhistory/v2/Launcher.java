...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting GetMaternityMedicalHistory testproducer");
		...
		final Object implementor = new GetMaternityMedicalHistory();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/clinicalprocess/healthcond/actoutcome/GetMaternityMedicalHistory/2/rivtabp21";
