...
public class ServiceTestDataGenerator extends TestDataGenerator {
  ...
  public String getPatientId(MessageContentsList messageContentsList) {
    GetMaternityMedicalHistoryType request =
        (GetMaternityMedicalHistoryType) messageContentsList.get(1);
  ...
  @Override
  public Object createResponseItem(
      String logicalAddress, String registeredResidentId, String businessObjectId, String time) {
    log.debug(
        "Created ResponseItem for logical-address {}, registeredResidentId {} and businessObjectId {}",
        new Object[] {logicalAddress, registeredResidentId, businessObjectId});

    MaternityMedicalRecordType response =
  ...
  public Object createRequest(String patientId, String sourceSystemHSAId) {
    GetMaternityMedicalHistoryType getMaternityMedicalHistory =
        new GetMaternityMedicalHistoryType();
    PersonIdType patient = new PersonIdType();
    patient.setId(patientId);
    getMaternityMedicalHistory.setPatientId(patient);
    getMaternityMedicalHistory.setSourceSystemHSAId(sourceSystemHSAId);
    return getMaternityMedicalHistory;
  }
}
